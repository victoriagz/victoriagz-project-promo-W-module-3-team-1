...
const Main = () => {
    ...
    const [descriptionTitle, setDescriptionTitle]= useState('Product description');
    ...
    return(
        ...
        <form className='addForm'>
          ...
          <InputButton textContent="Subir foto del proyecto"/>
          <InputButton textContent="Subir foto de la autora"/>
